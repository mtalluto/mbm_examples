...
mtext(side=1, "Climatic Distance", outer=TRUE, line=-1, cex=0.9)
dev.off()
...
rc(taxModelMF, ylim=c(0,1), lwd=2, xlim=c(0,4), cex_pt = cex_pt, col_line=cols[1], col_polygon=NA, xlab="Climatic Distance", ylab="Sørensen (Taxonomic) Dissimilarity", pch=pch)
